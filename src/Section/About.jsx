...
const About = () => {
  ...
  const expertise = [
    ...
    },
    {
      ...
      description:
        "Seamless API integration and database management for full-stack solutions.",
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-lg sm:text-xl text-gray-400 max-w-2xl mx-auto">
              Passionate frontend developer dedicated to creating exceptional
              digital experiences
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 mb-16">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4 text-gray-300 leading-relaxed">
                <p>
                  Hello! I'm Toukir Tuhin, a passionate frontend developer with
                  a keen eye for detail and a love for creating seamless user
                  experiences. My journey in web development started with
                  curiosity and has evolved into a professional pursuit of
                  excellence.
                </p>
                ...
                <p>
                  ...
                  reinforced my commitment to writing clean, efficient code.
                </p>
              ...
              <div>
                ...
                <div className="space-y-3">
                  {[
                    {
                      icon: "🎯",
                      text: "Delivering pixel-perfect, responsive designs",
                    },
                    {
                      icon: "⚡",
                      text: "Optimizing performance and user experience",
                    },
                    {
                      icon: "🤝",
                    ...
                    {
                      icon: "📚",
                      text: "Staying updated with latest technologies",
                    },
                  ].map((value, index) => (
                    <div
                      key={index}
